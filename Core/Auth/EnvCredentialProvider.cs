...
namespace TmCloud.SDK.Core.Auth
{
    ...
    {
        private const string AkEnvName = "TMCLOUD_SDK_AK";
        private const string SkEnvName = "TMCLOUD_SDK_SK";
        private const string ProjectIdEnvName = "TMCLOUD_SDK_PROJECT_ID";
        private const string DomainIdEnvName = "TMCLOUD_SDK_DOMAIN_ID";
        private const string SecurityTokenEnvName = "TMCLOUD_SDK_SECURITY_TOKEN";
