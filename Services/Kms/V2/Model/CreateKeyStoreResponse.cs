...
namespace TmCloud.SDK.Kms.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateKeyStoreResponse : SdkResponse
    {

        [JsonProperty("keystore", NullValueHandling = NullValueHandling.Ignore)]
        public KeystoreInfo Keystore { get; set; }
        ...
        {
            return this.Equals(input as CreateKeyStoreResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateKeyStoreResponse input)
        {
            if (input == null)
                return false;
