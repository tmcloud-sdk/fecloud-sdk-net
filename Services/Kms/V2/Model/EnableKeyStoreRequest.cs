...
namespace TmCloud.SDK.Kms.V2.Model
{
    ...
    /// Request Object
    /// </summary>
    public class EnableKeyStoreRequest 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnableKeyStoreRequest {\n");
        ...
        {
            return this.Equals(input as EnableKeyStoreRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(EnableKeyStoreRequest input)
        {
            if (input == null)
                return false;
