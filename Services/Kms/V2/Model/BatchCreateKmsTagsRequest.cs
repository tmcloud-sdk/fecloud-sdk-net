...
namespace TmCloud.SDK.Kms.V2.Model
{
    ...
    public class BatchCreateKmsTagsRequest 
    {
        ...
        public BatchCreateKmsTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateKmsTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateKmsTagsRequest input)
        {
            if (input == null)
                return false;
